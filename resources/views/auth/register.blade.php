...
@section('content')
    <div class="mx-auto max-w-sm">
        <h1 class="mb-6 text-2xl font-bold text-gray-900 dark:text-gray-100">Create an account</h1>
        ...
        <p class="mt-6 text-sm text-gray-500 dark:text-gray-400">
            ...
            <a href="{{ route('login') }}" class="font-medium text-blue-700 hover:underline dark:text-blue-400">Log in</a>
        </p>
    </div>
@endsection
